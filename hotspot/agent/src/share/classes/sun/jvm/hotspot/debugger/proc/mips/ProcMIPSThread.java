...
public class ProcMIPSThread implements ThreadProxy {
  ...
  public ThreadContext getContext() throws IllegalThreadStateException {
    ...
    */
    ...
    if (Assert.ASSERTS_ENABLED) {
      Assert.that(regs.length <= MIPSThreadContext.NPRGREG, "size of register set is greater than " + MIPSThreadContext.NPRGREG);
    }
  ...
  public boolean equals(Object obj) {
    if ((obj == null) || !(obj instanceof ProcMIPSThread)) {
      return false;
    }

    return (((ProcMIPSThread) obj).id == id);
  }
