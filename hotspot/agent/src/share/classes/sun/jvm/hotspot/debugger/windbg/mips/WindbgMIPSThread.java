...
package sun.jvm.hotspot.debugger.windbg.mips;

import sun.jvm.hotspot.debugger.*;
import sun.jvm.hotspot.debugger.mips.*;
import sun.jvm.hotspot.debugger.windbg.*;

class WindbgMIPSThread implements ThreadProxy {
  ...
  WindbgMIPSThread(WindbgDebugger debugger, Address addr) {
  ...
  WindbgMIPSThread(WindbgDebugger debugger, long sysId) {
    this.debugger = debugger;
    this.sysId    = sysId;
    gotID         = false;
  }
  ...
  public ThreadContext getContext() throws IllegalThreadStateException {
    ...
    WindbgMIPSThreadContext context = new WindbgMIPSThreadContext(debugger);
  ...
  public boolean equals(Object obj) {
    if ((obj == null) || !(obj instanceof WindbgMIPSThread)) {
      return false;
    }

    return (((WindbgMIPSThread) obj).getThreadID() == getThreadID());
  }
