...
// 2013/4/9 Jin: all merged from OpenJDK 8 [orderAccess_linux_zero.inline.hpp]
...
inline void*    OrderAccess::load_ptr_acquire(const volatile void* p) { void *data = *(void* const volatile *)p; acquire(); return data; }
...
inline void     OrderAccess::release_store_ptr(volatile intptr_t* p, intptr_t v) { release(); *p = v; fence(); }
inline void     OrderAccess::release_store_ptr(volatile void*     p, void*    v) { release(); *(void* volatile *)p = v; fence(); }
